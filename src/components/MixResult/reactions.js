export const reactionResult = {
  ...
  OcetSavo: {
    title: 'Naleptali jste si sliznici!',
    reaction: 'NaOCl + CH3COOH →  CH3COONa + HOCl',
    resultInfo:
      'Pálí vás oči a máte podrážděné dýchací cesty?Přesně tak, vyrobili jste si plynný chlór. Prvními příznaky je kašel a případně zvracení.',
  ...
  CitronSavo: {
    title: 'Naleplali jste si sliznice!',
