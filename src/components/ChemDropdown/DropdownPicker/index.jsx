  ...
  return (
    <>
      <div
        ...
        onClick={handleOpen}
      >
        Vyberte {order} chemikálii: <span className="arrow"></span>
      </div>
      <div className="dropdown__results container">
        {chemicalUrl && selectMain ? (
          <img className="dropdown__icon dropdown__img" src={chemicalUrl} />
        ) : null}
        {chemicalId && selectMain ? (
          <button
      ...
      {open ? (
        <div className="dropdown__grid container">
          ...
          {chemicals.map((chemical) => (
            <div
              className={
                selectForDisabled === chemical.id
                  ? "dropdown__grid-button disabled"
                  : "dropdown__grid-button"
              }
              key={chemical.id}
              value={chemical.id}
      ...
      {chemicalInfo && infoboxToggle && (
        <InfoBox id={chemicalInfo.id} onClose={handleCloseInfoBox} />
      )}
    </>
  );
};
